...
export type Database = {
  public: {
    Tables: {
      ...
      interview: {
        Row: {
          ...
          excel_skill_level: Database["public"]["Enums"]["excel_skill_level"] | null;
          practical_tasks: Json | null;
          task_templates: Json | null;
          conceptual_question_count: number | null;
          practical_task_count: number | null;
        };
        Insert: {
          created_at?: string;
          description?: string | null;
      ...
      response: {
        Row: {
          ...
          // Excel-specific fields
          excel_analytics: Json | null;
          spreadsheet_results: Json | null;
          current_state: Database["public"]["Enums"]["excel_interview_state"] | null;
          state_transitions: Json | null;
          conceptual_scores: Json | null;
          practical_scores: Json | null;
        };
        Insert: {
          analytics?: Json | null;
          call_id?: string | null;
      ...
      excel_skill_config: {
        Row: {
          id: number;
          skill_level: Database["public"]["Enums"]["excel_skill_level"];
          conceptual_topics: string[] | null;
          practical_skills: string[] | null;
          evaluation_criteria: Json | null;
          function_requirements: string[] | null;
      ...
      spreadsheet_result: {
        ...
        Relationships: [
          {
            foreignKeyName: "spreadsheet_result_response_id_fkey";
            columns: ["response_id"];
            isOneToOne: false;
      ...
      excel_interview_session: {
        Row: {
          id: number;
          response_id: number | null;
          current_state: Database["public"]["Enums"]["excel_interview_state"] | null;
          state_data: Json | null;
          conceptual_progress: Json | null;
          practical_progress: Json | null;
          start_time: string;
        ...
        Relationships: [
          {
            foreignKeyName: "excel_interview_session_response_id_fkey";
            columns: ["response_id"];
            isOneToOne: false;
            referencedRelation: "response";
            referencedColumns: ["id"];
    ...
    Enums: {
      ...
      excel_skill_level: "basic" | "intermediate" | "advanced";
      interview_type: "general" | "excel";
      excel_interview_state: "introduction" | "conceptual_questions" | "practical_tasks" | "feedback_generation" | "conclusion";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
