...
import ExcelInterviewCall from "@/components/excel-interview/ExcelInterviewCall";
...
function TraditionalCall({ interview }: InterviewProps) {
...
function Call({ interview }: InterviewProps) {
  // Check if this is an Excel interview
  if (interview && (interview as any).interview_type === 'excel') {
    return <ExcelInterviewCall interview={interview} />;
  }

  // Traditional voice interview logic
  return <TraditionalCall interview={interview} />;
}
